...
public class SubtypeResolutionIntegrationTest {
    ...
    @JsonTypeName("SubClassWithTypeNameAnnotation")
    ...
    private static class TestSubClass2 extends TestSuperClass {
        ...
        @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXTERNAL_PROPERTY, property = "externalTypeProperty")
        @JsonSubTypes({
